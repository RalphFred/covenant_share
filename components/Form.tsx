...
const schema = yup
  .object({
    ...
    status: yup
      ...
      .oneOf(
        ["found", "still looking"],
        "Status must be 'found' or 'still looking'"
      )
...
export default function Form() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      alert(
        "Form submitted successfully! Move to Board Page to see other students..."
      );
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 lg:px-16"
    >
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex flex-col lg:w-1/2">
          ...
          <input
            {...register("name")}
            className="border focus:border border-black rounded-lg py-2 px-2"
          />
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex flex-col lg:w-1/2">
          <label className="uppercase mb-2">Location</label>
          <input
            {...register("location")}
            className="border focus:border border-black rounded-lg py-2 px-2"
          />
